                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 my-2 bg-warning mx-2" style="height: 150px;">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <a href="patient.php"><i class="fa fa-procedures fa-3x my-4 fa-3x my-4" style="color: white;"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <h5 class="text-white my-4">List</h5>
                                                </div>
                                    ...
                                    <div class="col-md-3 my-2 bg-danger mx-2" style="height: 150px;">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <h5 class="text-white my-4">Add</h5>
                                                    <h5 class="text-white my-4">Treatment</h5>
                                                </div>

                                                <div class="col-md-4">
                                                    <a href="treatment.php"><i class="fa fa-file-medical fa-3x my-4 fa-3x my-4" style="color: white;"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 my-2 bg-info mx-2" style="height: 150px;">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <a href="record.php"><i class="fa fa-book-medical fa-3x my-4 fa-3x my-4" style="color: white;"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
